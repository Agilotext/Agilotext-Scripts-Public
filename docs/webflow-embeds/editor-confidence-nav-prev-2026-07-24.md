...
**Statut :** porté sur branche `1.09` en `1.09.6` (origine `f3bbc9e` / `feature/confidence-nav-prev-2026-07-24`, jamais mergée avant)

**Note août 2026 :** pendant les correctifs 1.09.2→1.09.5 l'embed Webflow a quitté le hash f3bbc9e pour @1.09, ce qui a fait disparaître le bouton UI. Restauré par port chirurgical (sans reprendre le floating top:10px / z-index:9999 de f3).
