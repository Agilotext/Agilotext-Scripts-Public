...
|---------|------|---------|
| `scripts/pages/editor/confidence-v1/Code-main-editor-IFRAME_V04-confidence.js` | 1, 2, 5 | `window.__agiloEditorConfidenceVersion = '1.09.5'` |
| `scripts/pages/editor/confidence-v1/agilo-confidence.js` | 5 | scroll borné « Passage suivant » + garde JS shell + float sans chrome mesurable |
| `scripts/pages/editor/confidence-v1/agilo-confidence.css.js` | 5 | retrait z-index chrome 40 ; scroll-margin segments |
...
```js
window.__agiloEditorConfidenceVersion  // '1.09.5'
