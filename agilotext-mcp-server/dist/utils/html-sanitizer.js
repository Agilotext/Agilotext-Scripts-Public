 ...
 */
export function validateEmailHtmlStructure(html) {
    const warnings = [];
    if (!html || typeof html !== "string") {
 ...
 */
export function createMultipartEmail(htmlContent, plainTextContent) {
    const sanitizedHtml = sanitizeHtml(htmlContent);
    const text = plainTextContent || htmlToPlainText(sanitizedHtml || htmlContent);
    return {
        html: sanitizedHtml,
        text: text,
    };
