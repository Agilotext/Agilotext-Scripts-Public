...
export class AgilotextError extends Error {
    ...
    data;
    endpoint;
    constructor(message, status, statusText, data, endpoint) {
        super(message);
...
export function formatError(error, endpoint, toolName) {
...
import { sanitizeObjectForLogging } from "./security/secret-sanitizer.js";
