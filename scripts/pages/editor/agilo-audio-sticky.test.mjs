...
assert(src.includes('border-radius:8px;overflow:visible}'), 'dock overflow visible pour hint Suivre');
assert(!src.includes('border-radius:8px;overflow:hidden}'), 'dock sans overflow hidden');
assert(src.includes('top:calc(100% + 6px)'), 'hint sous le bouton Suivre');
