// Agilotext - Protection Sauvegarde Transcript
...
(function() {
  ...
  // ⚠️ PROTECTION 2 : Intercepter le bouton "Sauvegarder" pour vérifier l'onglet actif
  ...
  protectSaveButton();
  setTimeout(protectSaveButton, 500);
