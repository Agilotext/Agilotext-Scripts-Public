...
(function () {
  ...
  async function refreshTokenForAudioDownload(userEmail, edition) {
    ...
    try {
      ...
      console.warn('[Agilo][MesTranscripts] window.getToken failed before audio download', err);
    }
    ...
    try {
      ...
      console.warn('[Agilo][MesTranscripts] getToken fallback failed', err);
    }
  ...
  async function verifyAudioDownloadUrl(url) {
    try {
      ...
      console.warn('[Agilo][MesTranscripts] verifyAudioDownloadUrl failed', err);
