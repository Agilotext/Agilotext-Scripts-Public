// Agilotext — Mes transcripts : bulk export / webhook / suppression (+ confirm modale) v2
// v2.0 — Hint pagination page courante. Charger AVANT logic-v2.js.
...
(() => {
  ...
  window.__agiloMesTranscriptsBulkVersion = '2.0';
