...
(function () {
  ...
  try {
    window.__agiloNavFolders = Object.assign(
      { version: '1.7.15', refresh: function () {} },
  ...
  function createSummary(auth) {
    ...
    /* Même classes Webflow que « Tableau de bord » (span = ok dans <summary>) ; SVG 24×24, pas Font Awesome 576×512 */
    const iconWrap = document.createElement('span');
    iconWrap.className = 'icon-small w-embed';
